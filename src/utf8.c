/* Copyright (C) 2011-2014,2018 G.P. Halkes
...
static t3_bool is_conjoining_jamo_v(uint32_t c) { return c >= 0x1161 && c <= 0x1175; }

// Returns whether a codepoint is one of the conjoining Jamo T codepoints.
static t3_bool is_conjoining_jamo_t(uint32_t c) { return c >= 0x11A7 && c <= 0x11C2; }
...
uint32_t t3_utf8_get(const char *src, size_t *size) {
  ...
  switch ((uint8_t)src[0]) {
    ...
    case 146: case 147: case 148: case 149: case 150: case 151: case 152: case 153: case 154:
    case 155: case 156: case 157: case 158: case 159: case 160: case 161: case 162: case 163:
    case 164: case 165: case 166: case 167: case 168: case 169: case 170: case 171: case 172:
    case 173: case 174: case 175: case 176: case 177: case 178: case 179: case 180: case 181:
    case 182: case 183: case 184: case 185: case 186: case 187: case 188: case 189: case 190:
    case 191: case 192: case 193:
      if (size != NULL) {
        *size = _size;
      }
      return 0xFFFD;
    case 194: case 195: case 196: case 197: case 198: case 199: case 200: case 201: case 202:
    case 203: case 204: case 205: case 206: case 207: case 208: case 209: case 210: case 211:
    case 212: case 213: case 214: case 215: case 216: case 217: case 218: case 219: case 220:
    ...
    case 240: case 241: case 242: case 243: case 244:
      ...
      retval = src[0] & 0x07;
      break;
    case 245: case 246: case 247: case 248: case 249: case 250: case 251: case 252: case 253:
    case 254: case 255:
      if (size != NULL) {
        *size = _size;
      }
...
*/
int t3_utf8_wcwidth(uint32_t c) { return (int)(get_chardata(c) >> 6) - 1; }
